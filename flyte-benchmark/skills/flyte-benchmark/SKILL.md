...
python _runner.py fanout      n_children=1000 sleep_seconds=0 | tee -a ../results.jsonl
python _runner.py long_chain  length=100      sleep_seconds=0 | tee -a ../results.jsonl
python _runner.py concurrency m=5000 hold_seconds=120         | tee -a ../results.jsonl
